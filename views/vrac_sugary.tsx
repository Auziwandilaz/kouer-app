...
import { theme_sugary as theme } from "../lib/constants";
import { Filters } from "../lib/constants";
import IconSugary from "../components/svg/icon_sugary";

const { width: screenWidth, height: screenHeight } = Dimensions.get("window");

export default function VracSugary({ navigation }) {
    ...
    <SafeAreaView className="flex-1">
      ...
      <View className={`flex-1 ${showFilter ? "hidden" : ""}`}>
        <View className="h-[25vh]">
          ...
          >
            <IconSugary className="w-12 mr-2" />
