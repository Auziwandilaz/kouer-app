...
import { theme_milk as theme } from "../lib/constants";
import { Filters } from "../lib/constants";
import IconMilk from "../components/svg/icon_milk";

const { width: screenWidth, height: screenHeight } = Dimensions.get("window");

export default function VracMilk({ navigation }) {
    ...
    <SafeAreaView className="flex-1">
      ...
      <View className={`flex-1 ${showFilter ? "hidden" : ""}`}>
        <View className="h-[25vh]">
          ...
          >
            <View>
              <Text style={{ color: "#fff", fontSize: 25 }}>Vrac</Text>
            </View>
          </LinearGradient>
          <View>
            <SearchProvider>
