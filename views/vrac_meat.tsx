...
import IconMeat from "../components/svg/icon_meat";
...
import { theme_meat as theme } from "../lib/constants";
import { Filters } from "../lib/constants";

export default function VracMeat({ navigation }) {
