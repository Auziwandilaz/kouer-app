...
import { theme_takeaway as theme } from '../lib/constants';
import { Filters } from '../lib/constants';
import IconTakeaway from '../components/svg/icon_takeaway';

export default function VracTakeaway({ navigation }) {
    ...
    <SafeAreaView className='flex-1'>
      ...
      <View className={`flex-1 ${showFilter ? 'hidden' : ''}`}>
        <View className='h-[25vh]'>
          ...
          >
            <IconTakeaway className='w-12 mr-2' />
