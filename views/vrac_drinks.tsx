...
import IconDrinks from "../components/svg/icon_drinks";
...
import { theme_drinks as theme } from "../lib/constants";
import { Filters } from "../lib/constants";

const { width: screenWidth, height: screenHeight } = Dimensions.get("window");

export default function Vracdrinks({ navigation }) {
    ...
    <SafeAreaView className="flex-1">
      ...
      <View className={`flex-1 ${showFilter ? "hidden" : ""}`}>
        <View className="h-[25vh]">
          ...
          >
            <IconDrinks className="w-12 mr-2" />
