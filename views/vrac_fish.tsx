...
import IconFish from '../components/svg/icon_fish';
...
import { theme_fish as theme } from '../lib/constants';
import { Filters } from '../lib/constants';

const { width: screenWidth, height: screenHeight } = Dimensions.get('window');

export default function VracFish({ navigation }) {
